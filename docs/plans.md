...
4. זמני התחלה בקפיצות של 15 דקות. הזמנה רגילה נמשכת בדיוק 60 דקות. ססיה מוגדרת בשעת התחלה וסיום, לפחות שעה, ללא מקסימום (עד יום פעילות שלם), באותו יום. (עודכן 4.9.2026)
...
15. ססיה נמשכת עד 10 שנים (עודכן 4.9.2026; במקור 52 שבועות).
...
מתחם, חדר, מטפל מאושר במתחם, יום בשבוע, שעת התחלה וסיום (בקפיצות של 15 דקות, לפחות שעה, ללא מקסימום, באותו יום, בתוך מקטע פעילות אחד), תאריך התחלה וסיום (כולל, עד 10 שנים), הערה, מצב (`ACTIVE`, `ENDED`, `CANCELLED`).
...
- **SES-005:** משך ססיה לפחות שעה, ללא מקסימום, באותו יום; בדיקות, יומן ודוחות מתייחסים לכל המשך.
